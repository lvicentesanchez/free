...
package object modules {
  ...
  object all extends QueueInstances with QueueFunctions with StdIOInstances with StdIOFunctions with TimerInstances with TimerFunctions with UsersInstances with UsersFunctions
}
